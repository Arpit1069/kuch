...
public class WaterJugSolverbfs {
    public static void bfs(WaterJugState initialState, int targetAmount, int jugACapacity, int jugBCapacity) {
    ...
    public static void main(String[] args) {
        int jugACapacity = 5;
        int jugBCapacity = 3;
        int targetAmount = 4; // Desired amount of water

        WaterJugState initialState = new WaterJugState(0, 0); // Initially both jugs are empty
        System.out.println("Initial State:");
        initialState.printState();

        bfs(initialState, targetAmount, jugACapacity, jugBCapacity);
    }
}
